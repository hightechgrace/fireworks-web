  ...
  render() {
    return (
      <div>
        ...
        <section className="uk-position-relative uk-hidden@m uk-section-secondary uk-section-large " data-uk-height-viewport style={{ backgroundColor: "#000" }}>
          <Nav />
          <div className="uk-container uk-container-xlarge uk-margin-left uk-margin-right" >
        ...
        <section className='uk-visible@m uk-section-white uk-section-large fwk-home-section'  >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            ...
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 style={{ fontSize: '20vw', fontWeight: '700', color: '#F6F6F6' }} >Agency</h1>
        ...
        <section className='uk-hidden@m uk-section-white uk-section-large' >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            <h2 className='uk-margin-large-top fwk-mobile-home-h2'>Our Arms.</h2>
            <div><h6 style={{ letterSpacing: '5px' }}>CREATIVE AGENCY</h6></div>
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 className='uk-margin-xlarge-top' style={{ fontSize: '25vw', fontWeight: '700', color: '#F6F6F6' }} >Agency</h1>
              <div className='uk-width-1-1'>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m uk-text-center" >
                    <img src={Agency} width='220' style={{ marginTop: '-180px' }} />
                  </div>
        ...
        <section className='uk-visible@m uk-section-white uk-section-large fwk-home-section'  >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            ...
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 style={{ fontSize: '20vw', fontWeight: '700', color: '#F6F6F6' }} >Studios</h1>
              <div className='uk-width-1-1' style={{ position: 'absolute', top: '0' }}>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m" >
        ...
        <section className='uk-hidden@m uk-section-white uk-section-large' >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            <div><h6 style={{ letterSpacing: '5px' }}>STUDIOS</h6></div>
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 className='uk-margin-xlarge-top' style={{ fontSize: '25vw', fontWeight: '700', color: '#F6F6F6' }} >Studios</h1>
              <div className='uk-width-1-1'>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m uk-text-center" >
                    <img src={Studio} width='220' style={{ marginTop: '-180px' }} />
                  </div>
                  <div className="uk-width-1-1@m uk-margin-top" >
                    <div>
                      <p className='uk-text-left'>We tell authentic African stories through film and photography. We are dedicated to creating and
        ...
        <section className='uk-visible@m uk-section-white uk-section-large fwk-home-section'  >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            ...
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 style={{ fontSize: '20vw', fontWeight: '700', color: '#F6F6F6' }} >Brands</h1>
              <div className='uk-width-1-1' style={{ position: 'absolute', top: '0' }}>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m" >
 ...
 through authentic, inspiring and engaging storytelling. </p>
        ...
        <section className='uk-hidden@m uk-section-white uk-section-large' >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            <div><h6 style={{ letterSpacing: '5px' }}>MEDIA BRANDS</h6></div>
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 className='uk-margin-xlarge-top' style={{ fontSize: '25vw', fontWeight: '700', color: '#F6F6F6' }} >Brands</h1>
              <div className='uk-width-1-1'>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m uk-text-center" >
                    <img src={Brands} width='220' style={{ marginTop: '-180px' }} />
                  </div>
                  <div className="uk-width-1-1@m uk-margin-top" >
                    <div>
                      <p className='uk-text-left'>We are dedicated to building media brands that
 ...
 through authentic, inspiring and engaging storytelling. </p>
        ...
        <section className='uk-visible@m uk-section-white uk-section-large fwk-home-section'  >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            ...
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 style={{ fontSize: '15vw', fontWeight: '700', color: '#F6F6F6' }} >Technology</h1>
              <div className='uk-width-1-1' style={{ position: 'absolute', top: '0' }}>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m" >
...
And Development </p>
        ...
        <section className='uk-hidden@m uk-section-white uk-section-large' >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            <div><h6 style={{ letterSpacing: '5px' }}>TECHNOLOGY</h6></div>
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 className='uk-margin-xlarge-top' style={{ fontSize: '18vw', fontWeight: '700', color: '#F6F6F6' }} >Technology</h1>
              <div className='uk-width-1-1'>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m uk-text-center" >
                    <img src={Brands} width='220' style={{ marginTop: '-150px' }} />
                  </div>
                  <div className="uk-width-1-1@m uk-margin-top" >
                    <div>
                      <p className='uk-text-left'>We blend design and technology to create meaningful
...
And Development </p>
        ...
        <section className='uk-visible@m uk-section-white uk-section-large fwk-home-section'  >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            ...
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 style={{ fontSize: '20vw', fontWeight: '700', color: '#F6F6F6' }} >Fire X</h1>
              <div className='uk-width-1-1' style={{ position: 'absolute', top: '0' }}>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m" >
...
Summits, Exhibitions, Brand & Product Launches.
        ...
        <section className='uk-hidden@m uk-section-white uk-section-large' >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            <div><h6 style={{ letterSpacing: '5px' }}>FIRE X</h6></div>
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 className='uk-margin-xlarge-top' style={{ fontSize: '28vw', fontWeight: '700', color: '#F6F6F6' }} >Fire  X</h1>
              <div className='uk-width-1-1'>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m uk-text-center" >
                    <img src={Firex} width='220' style={{ marginTop: '-180px' }} />
                  </div>
                  <div className="uk-width-1-1@m uk-margin-top" >
                    <div>
                      <p className='uk-text-left'>We create and deliver unique live experiences.
  ...
  Summits, Exhibitions, Brand & Product Launches.
        ...
        <section className='uk-visible@m uk-section-white uk-section-large fwk-home-section'  >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            ...
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 style={{ fontSize: '13vw', fontWeight: '700', color: '#F6F6F6' }} >Fireworks U</h1>
              <div className='uk-width-1-1' style={{ position: 'absolute', top: '0' }}>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m" >
...
and strategies to grow world class brands
        ...
        <section className='uk-hidden@m uk-section-white uk-section-large' >
          <div className="uk-container uk-container-xlarge" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: div; delay: 200; repeat: true">
            <div><h6 style={{ letterSpacing: '5px' }}>FIREWORKS U</h6></div>
            <div className='uk-width-1-1' style={{ position: 'relative', backgroundColor: '' }}>
              <h1 className='uk-margin-xlarge-top' style={{ fontSize: '15vw', fontWeight: '700', color: '#F6F6F6' }} >Fireworks U</h1>
              <div className='uk-width-1-1'>
                <div className="" data-uk-grid>
                  <div className="uk-width-1-5@m"></div>
                  <div className="uk-width-1-3@m uk-text-center" >
                    <img src={FireworksU} width='220' style={{ marginTop: '-140px' }} />
                  </div>
                  <div className="uk-width-1-1@m uk-margin-top" >
                    <div>
                      <p className='uk-text-left'>Arming individuals and organisations with knowledge
  and strategies to grow world class brands
        ...
        <section className=' uk-visible@m uk-section-white uk-section-small fwk-home-section uk-margin-large-top' >
          <div className="uk-container uk-container-xlarge" >
