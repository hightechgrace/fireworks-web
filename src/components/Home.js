...
class Home extends Component {
    render() {
        ...
        console.log('here>>', instafeedTarget)
        return (
            <div>
                <Nav />
                <div className="uk-section uk-section-large home-bg" data-uk-height-viewport>
                    <div className="uk-container uk-container-large uk-margin-left uk-margin-right">
                        <div className="uk-dark uk-position-center-left uk-margin-large-left">
                            <Typing speed={50}>
                                ...
                                <h1 className='uk-text-left uk-heading-primary' style={{ fontSize: '70px' }}>We combine <span className='underline'> storytelling</span> and <br />
                                    <span className='underline'> technology</span> to give meaningful <br />
                                    experiences </h1>
                ...
                <div className="uk-section uk-section-secondary uk-light home-view brand-bg ">
                    <div className="uk-container uk-margin-large-top uk-margin-large-bottom" style={{ paddingTop: '20px', paddingBottom: '150px' }}>
                        <img className='floating uk-align-right' src={astro} width='550px' style={{ marginTop: '-600px' }} />
                                    ...
                                    <div className=''>
                                        <div className=" uk-width-3-5 uk-card uk-card-default uk-padding-small  uk-position-center-left uk-text-left brand-card" data-uk-scrollspy="cls: uk-animation-slide-left; repeat: true">
                                            <div className='uk-padding-small'>
                                                ...
                                                <a data-uk-scrollspy="cls: uk-animation-slide-right; repeat: true; delay:500" className="uk-text-left uk-margin-top uk-button  uk-text-capitalize black-btn red" data-uk-icon="icon: arrow-right; ratio: 1.6"><span className='white'>Explore</span>  </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            <div className=" uk-width-3-5 uk-card uk-card-default uk-padding-small uk-position-center-left uk-text-left brand-card" data-uk-scrollspy="cls: uk-animation-slide-right; repeat: true; delay:400">
                                                <div className='uk-padding-small'>
                                                    ...
                                                    <div className='uk-margins red-card-bar'></div>
                                                    <a data-uk-scrollspy="cls: uk-animation-slide-left; repeat: true; delay:800" className="uk-text-left uk-margin-top uk-button  uk-text-capitalize black-btn red" data-uk-icon="icon: arrow-right; ratio: 1.6"><span className='white'>Explore</span>  </a>
                                        ...
                                        <div>
                                            <div className=" uk-width-3-5 uk-card uk-card-default uk-padding-small uk-position-center-left uk-text-left brand-card" data-uk-scrollspy="cls: uk-animation-slide-right; repeat: true; delay:400">
                                                <div className='uk-padding-small'>
                                                    ...
                                                    <div className='uk-margins red-card-bar'></div>
                                                    <a data-uk-scrollspy="cls: uk-animation-slide-right; repeat: true; delay:1100" className="uk-text-left uk-margin-top uk-button  uk-text-capitalize black-btn red" data-uk-icon="icon: arrow-right; ratio: 1.6"><span className='white'>Explore</span>  </a>
                        ...
                        <div className="uk-hidden@m uk-child-width-1-3@l uk-text-center uk-grid-match" data-uk-grid>
                            <div className='uk-margin-xlarge-bottom'>
                                <div className="uk-inline">
                                    <img data-uk-scrollspy="cls: uk-animation-slide-bottom; repeat: true" src={young} alt="" />
                                    <div className=''>
                                        <div className=" uk-width-4-5 uk-card uk-card-default  uk-position-center-left uk-text-left brand-card" data-uk-scrollspy="cls: uk-animation-slide-left; repeat: true">
                                            <div className='uk-padding-small'>
                                                <img data-uk-scrollspy="cls: uk-animation-scale-up; repeat: true; delay:300" src={young_logo} width='150' alt='' />
                                                <p className='black uk-text-meta '>news, pop culture and lifestyle magazine. the voice of a movement, expressing the passions and narrative of a generation that refuses to be left behind</p>
                                                <div className='uk-margin red-card-bar'></div>
                                                <a data-uk-scrollspy="cls: uk-animation-slide-right; repeat: true; delay:500" className="uk-text-left uk-button  uk-text-capitalize black-btn red" data-uk-icon="icon: arrow-right; ratio: 1.6"><span className='white'>Explore</span>  </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div className='uk-margin-xlarge-top uk-margin-xlarge-bottom'>
                                    <div className="uk-inline" >
                                        ...
                                        <div>
                                            <div className=" uk-width-4-5 uk-card uk-card-default  uk-position-center-left uk-text-left brand-card" data-uk-scrollspy="cls: uk-animation-slide-right; repeat: true; delay:400">
                                                <div className='uk-padding-small'>
                                                    ...
                                                    <div className='uk-margin red-card-bar'></div>
                                                    <a data-uk-scrollspy="cls: uk-animation-slide-left; repeat: true; delay:900" className="uk-text-left uk-button  uk-text-capitalize black-btn red" data-uk-icon="icon: arrow-right; ratio: 1.6"><span className='white'>Explore</span>  </a>
                ...
                <div className="uk-section uk-section-large">
                    <div className="uk-container">
                        ...
                        <h3>
                            ...
                            Follow us on <span className='red underline'>Facebook</span>, <span className='red underline'>Twitter</span> and <span className='red underline'>Instagram</span> to get <br />
                            more information and inside details from us
                        </h3>
                         </div>
                         <div id={instafeedTarget} className='uk-flex uk-flex-center uk-margin-xlarge-top uk-animation-fade'>
                                <Instafeed
                                    limit='5'
                                    ref='instafeed'
                ...
                <div className="uk-section uk-section-large ">
                    <div className="uk-container uk-text-center">
                        ...
                        <a data-uk-scrollspy="cls: uk-animation-slide-left; repeat: true; delay:200" className="uk-text-left uk-margin-top uk-button  uk-text-capitalize black-btn red" data-uk-icon="icon: arrow-right; ratio: 1.6"><span className='white'>Lets Talk</span>  </a>
